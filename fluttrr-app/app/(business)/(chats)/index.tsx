...
export default function BizChatsScreen() {
  ...
  const getChatSubtitle = (chat: ChatListItem): string => {
    ...
    if (chat.type === ChatType.BIZ_DM) return 'Customer Chat';
        ...
        ListEmptyComponent={
          loading ? (
            ...
            <EmptyState
              emoji="💬"
              title="No chats yet"
              subtitle="Chats will appear here when users join your events."
            />
          )
        }
